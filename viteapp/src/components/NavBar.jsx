    ...
    <nav className="border-gray-200 bg-navy-blue dark:bg-navy-blue dark:border-gray-700 w-full z-20">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-5 px-8">
        ...
        <button
          onClick={toggleNav}
          type="button"
          className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden dark:bg-navy-blue hover:bg-royal-blue-800 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-royal-blue-800 dark:focus:ring-gray-600"
